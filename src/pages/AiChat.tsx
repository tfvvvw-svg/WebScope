    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col gap-8">
      ...
      >
        <div>
          ...
          <p className="text-xs text-zinc-400 mt-1">
            Задайте любой вопрос о проанализированном сайте. AI использует все данные сканирования.
          </p>
        </div>
        {messages.length > 0 && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          <Card variant="glass" className="flex flex-col" style={{ minHeight: '600px' }}>
            ...
            <CardContent className="flex-1 overflow-y-auto p-4 flex flex-col gap-4" style={{ maxHeight: '600px' }}>
              {messages.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-white mb-2">Начните диалог</h3>
